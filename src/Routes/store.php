...
$storeRoutes->add('store_create', new Route('/store/ingredients/create', [
    '_controller' => [StoreController::class, 'create'],
    '_auth' => true,
    '_permission' => 'inventory.create',
], methods: ['GET']));

$storeRoutes->add('store_save', new Route('/store/ingredients/create', [
...
$storeRoutes->add('store_edit', new Route('/store/ingredients/edit/{id}', [
    '_controller' => [StoreController::class, 'edit'],
    '_auth' => true,
    '_permission' => 'inventory.update',
], methods: ['GET']));

$storeRoutes->add('store_update', new Route('/store/ingredients/edit/{id}', [
...
$storeRoutes->add('store_deactivate', new Route('/store/ingredients/deactivate/{id}', [
...
$storeRoutes->add('store_stock_form', new Route('/store/ingredients/{id}/stock', [
    '_controller' => [StoreController::class, 'stockForm'],
    '_auth' => true,
    '_permission' => 'inventory.update',
], methods: ['GET']));

$storeRoutes->add('store_stock_save', new Route('/store/ingredients/{id}/stock', [
